...
commander
  ...
  .option('-s, --source [value]', 'Use a custom template instead the official.')
...
commander
  ...
  .option('-t, --target [value]', 'Target: production (default), qa1, any, ...')
  .action(buildCommand);
...
// test
commander.command('test').description('Unit test the app.').action(testCommand);
